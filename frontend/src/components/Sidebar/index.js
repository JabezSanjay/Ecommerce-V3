    ...
    <>
      ...
      <!-- Remove className [ hidden ] and replace [ sm:flex ] with [ flex ] --> */}
        ...
        >
          <div className=''>
            <ul className=''>
              <li className='p-3 flex w-full justify-between text-primary-600 hover:bg-gray-100 cursor-pointer items-center my-4'>
                <a
                  href='/'
              ...
              <li className='p-3 text-primary-600 hover:bg-gray-100 flex w-full justify-between  cursor-pointer items-center my-4'>
                <Link
                  to='/'
                  className='flex items-center focus:outline-none focus:ring-2 focus:ring-white'
                >
                  ...
                  <span className='text-md ml-2'>Explore</span>
                </Link>
              </li>
              <li className='p-3 flex w-full justify-betwee cursor-pointer items-center text-primary-600 hover:bg-gray-100 my-4 justify-between'>
                <Link
                  to='/'
                  className='flex items-center focus:outline-none focus:ring-2 focus:ring-white'
                >
                  ...
                  <span className='text-md ml-2'>Deliverables</span>
                </Link>
              </li>
              <li
                className={`p-3 ${
